...
timeout 5m python3 app.py runs/detect/train/weights/best.pt videos/videos-seasons/wenig_nacht.mp4 > jetson_bestPt_seasons-wenig-nacht.txt
...
timeout 5m python3 app.py runs/detect/train/weights/best.pt videos/videos-seasons/mittel_1.mp4 > jetson_bestPt_seasons-mittel1.txt
