...
PATH_TO_JSON = '/home/mika/edgeAI/data/deepdrive/annotations/det_20/det_val.json'
IMAGE_DIR = '/home/mika/edgeAI/data/deepdrive/images/'
LABEL_DIR = '/home/mika/edgeAI/data/deepdrive/labels/'
OUTPUT_DIR = '/home/mika/edgeAI/data/subset1/'
...
def create_new_folder(json_name):
...
def main():
    ...
    img_path, labels_path, subdir = create_new_folder(PATH_TO_JSON)
